# USAGE python segment.py --model enet-cityscapes/enet-model.net --classes enet-cityscapes/enet-classes.txt --colors
# enet-cityscapes/enet-colors.txt --image images/example_01.png
